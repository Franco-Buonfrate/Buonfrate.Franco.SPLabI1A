...
/** \brief Le pasa todos los elemntos de la linkedList a la funcion pFunc para que esta cargue los campos
 *
 * \param lista LinkedList* lista con los elemntos a cargar
 * \param *pFunc void* puntero a funcion
 * \return retorna una nueva linkedList con los campos de los elemntos cargados
 *
 */
...
LinkedList* ll_map (LinkedList* lista, void* (*pFunc) (void*))
{
    ...
    {
        ll_add(nuevaLista, pFunc(ll_get(lista, i)));
    }
